        ...
        <div class="flex justify-between items-center">
            ...
            <div>
                <a class="px-4 py-3 bg-blue-500 text-white hover:bg-blue-700 rounded"
                    href="{{ route('admin.pages.add') }}">Add Page</a>
            </div>
        </div>
    </x-slot>
                                ...
                                @foreach ($pages as $page)
                                    <tr class="border-collapse border border-gray-300">
                                        ...
                                        <td class="px-4 py-2 text-gray-800 font-medium">
                                            {{ $page->created_at->diffForHumans() }}</td>
                                        <td class="px-4 py-2 text-gray-800 font-medium">
                                            {{ $page->updated_at->diffForHumans() }}</td>
                                        <td class="px-4 py-2 text-gray-800 font-medium">
                                            <div class="flex items-center">
                                                <a title="View Page" href="{{ route('page', $page->slug) }}"
                                                    target="_blank"
                                                    class="inline-block mr-2 border-2 border-indigo-200 rounded-md p-1 hover:bg-indigo-700 text-indigo-500 hover:text-white hover:border-indigo-700">
                                                ...
                                                <a title="Edit Page" href="{{ route('admin.pages.edit', $page->id) }}"
                                                ...
                                                <button title="Delete Page" type="button"
