...
<head>
    ...
    <!-- Stroke 7 -->
    <link rel="stylesheet" href="{{ asset('assets/bower_components/pixeden-stroke-7-icon/pe-icon-7-stroke/dist/pe-icon-7-stroke.min.css') }}">
    <!-- Flickity -->
...
<div class="nk-main bg-white" id="app">
...
<footer class="nk-footer">
    <div class="container">
        <div class="row vertical-gap">
            <div class="col-lg-5">
                <p class="mb-0">&copy; {{ date('Y') }} {{ config('app.name') }}.<br>All rights reserved.</p>
            </div>
            <div class="col-lg-1"></div>
            <div class="col-lg-3">
                <a href="#">ksmppdm@gmail.com</a>
                <br> +91 9443046886
            </div>
            <div class="col-lg-3">
